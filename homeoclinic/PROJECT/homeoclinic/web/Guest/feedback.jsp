...
<table width="">
	...
	<tr>
            <td>Name</td><td><input type="text"  value="<%=patname%>"   id="txt_pname" name="txt_pname" ></td>
              ...
              <tr>
            <td>Feedback</td><td><textarea value=""   id="txt_feedback" name="txt_feedback" ><%=feedback%></textarea></td>
	</tr>
        <tr>
            <td>Date</td><td><input type="date"  value="<%=fdate%>"   id="date" name="date" ></td>
	</tr> <tr>
            <td>Time</td><td><input type="time"  value="<%=ftime%>"   id="time" name="time" ></td>
	</tr>
	<tr>
