	...
	<td><input type="reset" id="btn_reset" name="btn_reset" value="Cancel"</td>
            ...
            <table border=".1">
                ...
                <%
                    ...
                    while(rs.next())
                    { %>
                    <tr><td><%= rs.getString("des_name")%></td><td><a href="Designation.jsp?eid=<%= rs.getString("des_id")%>">Edit</a> 
                        <td><a href="Designation.jsp?did=<%= rs.getString("des_id")%>">Delete</a></td></td></tr>
                    <%     
                              }
